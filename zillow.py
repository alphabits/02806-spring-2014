...
addresses = [ 
    "6 Washington", "21 Manassas", "280 Pearl", "55 Ellery", "50 Follen", "51 Granite", "992 Memorial", "83 Trowbridge", "1 Dana", "45 Regent", 
    "90 Alpine", "21 Francis", "112 Avon Hill", "9 Bellevue", "4 Blanchard Rd", "34 Shea", "5 Fountain", "14 Marcella", "39 Saint Saveur", 
    "35 Pemberton", "46 Shepard", "31 Market", "99 Howard", "88 Pearl", "208 Western", "285 Windsor", "26 Cambridgepark", "211 Erie", 
    "129 Franklin", "27 Gurney", "149 Prospect", "27 Linnaean", "20 Dudley", "60 Otis St", "130 Mount Auburn St", "2 Michael Way", 
    "263 Columbia St", "6 Hurlbut St", "199 Harvard St", "168 River St", "400 Washington St", "12 Traill St", "74 Field St", "21 Walden Square Rd", 
    "7 Wendell St", "15 Normandy Ave", "6 Gibson Ter", "94 Pine St", "23 Magee St", "175 Richdale Ave", "168 River St", "246 Brattle St"
]
...
def get_address_data(address):
    ...
    return get_address_data_from_result_element(result)

def get_address_data_from_result_element(result):
    try:
        return [_get_attribute_value_from_result(result, xml_attribute, parser) 
                for xml_attribute, parser in _parse_setup]
    except:
        return None

def _get_attribute_value_from_result(result, xml_attribute, parser):
    xml_elements = result.getElementsByTagName(xml_attribute)
    xml_element = xml_elements[0].firstChild
    return parser(xml_element.data)
